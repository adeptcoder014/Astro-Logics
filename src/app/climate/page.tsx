...
import NativityCurrentStoryTab from '../components/nativity/currentStory/NativityCurrentStoryTab';
import {
...
export default function CosmicClimatePage() {
  ...
  return (
    <Layout>
      ...
      <NativityCurrentStoryTab 
        nativityChartId='6a1a8da3880574e3556fad36'
      />
