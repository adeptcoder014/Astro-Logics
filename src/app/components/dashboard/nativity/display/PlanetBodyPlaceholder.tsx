...
export default function PlanetPersonalityChat({
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-[#1A1815] to-[#0F0D0C] rounded border border-[#2D241E]">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#2D241E] to-[#1A1815] p-4 border-b border-[#3D3530]">
      ...
      {context.aspectsWithOthers.length > 0 && (
        <div className="px-4 pt-3 pb-2 border-b border-[#2D241E]">
      ...
      {/* Input Area */}
      <div className="border-t border-[#2D241E] p-4 bg-[#0F0D0C]">
